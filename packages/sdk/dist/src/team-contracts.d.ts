...
export declare const TEAM_ROLE_PERMISSION_TEMPLATES: {
    ...
    readonly crew: {
        ...
        readonly permissions: readonly ["calls.place", "messages.read", "appointments.read", "appointments.update", "appointment_media.capture", "payments.read", "payments.collect", "expenses.read", "expenses.write"];
    };
    readonly read_only: {
