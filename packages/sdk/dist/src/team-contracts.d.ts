 ...
 */
export declare const TEAM_PERMISSION_CATALOG: readonly ["access.break_glass", "access.manage", "ad_spend.write", "appointments.read", "appointments.update", "appointments.override_conflicts", "appointment_media.capture", "appointment_media.manage", "audit.read", "audit.export", "automation.read", "automation.simulate", "automation.write", "bookings.manage", "calls.place", "calls.reconcile", "contacts.read", "contacts.write", "contacts.delete", "contacts.restore", "contacts.purge", "contacts.merge", "expenses.read", "expenses.export", "expenses.write", "expenses.submit", "expenses.approve", "properties.read", "properties.write", "properties.delete", "pipeline.read", "pipeline.write", "messages.read", "messages.write", "messages.upload", "messages.delete", "messages.send", "messages.export", "payments.read", "payments.collect", "payments.manage", "payments.reconcile", "policy.read", "policy.write", "quotes.read", "quotes.write", "quotes.send", "quotes.update", "quotes.delete", "sales.read", "sales.write", "sales.reset", "sessions.manage_self", "outbound.read", "outbound.write", "outbound.import", "partners.read", "partners.write", "partners.invite", "partners.rates", "partners.accounts.read", "partners.applications.read", "partners.joins.read", "partners.people.read", "partners.memberships.read", "partners.invitations.read", "partners.domains.read", "partners.security.read", "partners.quarantine.read", "partners.preview.read", "partners.commercial.read", "partners.relationships.manage", "partners.accounts.manage", "partners.accounts.lifecycle", "partners.applications.review", "partners.applications.approve", "partners.applications.decline", "partners.joins.review", "partners.joins.approve", "partners.joins.decline", "partners.invitations.send", "partners.invitations.revoke", "partners.memberships.manage", "partners.memberships.suspend", "partners.memberships.migration.review", "partners.domains.manage", "partners.domains.verify", "partners.domains.revoke", "partners.security.sessions.revoke", "partners.quarantine.contain", "partners.reconciliation.manage", "partners.commercial.manage", "partners.identities.disable", "partners.security.mfa.reset", "partners.memberships.recover_admin", "partners.domains.override", "partners.accounts.merge", "partners.accounts.close", "partners.quarantine.release", "finance.read", "financials.read", "commissions.read", "commissions.manage", "commissions.pay", "marketing.read", "marketing.write", "marketing.apply", "marketing.publish", "outbox.dispatch"];
...
export declare const TEAM_PARTNER_LEGACY_PERMISSION_COMPATIBILITY: {
    readonly "partners.read": readonly ["partners.accounts.read", "partners.applications.read", "partners.joins.read", "partners.people.read", "partners.memberships.read", "partners.invitations.read", "partners.domains.read", "partners.security.read", "partners.quarantine.read", "partners.preview.read", "partners.commercial.read"];
    readonly "partners.write": readonly ["partners.relationships.manage", "partners.accounts.manage", "partners.domains.manage", "partners.accounts.lifecycle", "partners.quarantine.contain", "partners.reconciliation.manage"];
    readonly "partners.invite": readonly ["partners.applications.review", "partners.applications.approve", "partners.applications.decline", "partners.joins.review", "partners.joins.approve", "partners.joins.decline", "partners.invitations.send", "partners.invitations.revoke", "partners.memberships.manage", "partners.memberships.suspend", "partners.memberships.migration.review", "partners.domains.verify", "partners.domains.revoke", "partners.reconciliation.manage"];
    readonly "partners.rates": readonly ["partners.commercial.read", "partners.commercial.manage"];
};
/** Stored-role inputs accepted at runtime but unavailable for new grants. */
export declare const TEAM_PARTNER_LEGACY_PERMISSION_CATALOG: readonly ["partners.read", "partners.write", "partners.invite", "partners.rates"];
 ...
 */
export declare const TEAM_OWNER_ONLY_PERMISSION_CATALOG: readonly ["contacts.purge", "expenses.approve", "financials.read", "ad_spend.write", "partners.identities.disable", "partners.security.mfa.reset", "partners.memberships.recover_admin", "partners.domains.override", "partners.accounts.merge", "partners.accounts.close", "partners.quarantine.release"];
export type TeamOwnerOnlyPermission = (typeof TEAM_OWNER_ONLY_PERMISSION_CATALOG)[number];
export type TeamAssignablePermission = Exclude<TeamPermission, "access.break_glass" | TeamOwnerOnlyPermission | "sessions.manage_self" | (typeof TEAM_PARTNER_LEGACY_PERMISSION_CATALOG)[number]>;
...
export declare function isAssignableTeamPermission(value: string): value is TeamAssignablePermission;
/**
 ...
 */
export declare const TEAM_READ_ONLY_PERMISSIONS: readonly ["appointments.read", "audit.read", "automation.read", "contacts.read", "expenses.read", "properties.read", "pipeline.read", "messages.read", "policy.read", "quotes.read", "sales.read", "outbound.read", "partners.accounts.read", "partners.applications.read", "partners.joins.read", "partners.people.read", "partners.memberships.read", "partners.invitations.read", "partners.domains.read", "partners.security.read", "partners.quarantine.read", "partners.preview.read", "partners.commercial.read", "finance.read", "commissions.read", "marketing.read"];
/**
...
export declare const TEAM_ROLE_PERMISSION_TEMPLATES: {
    ...
    readonly crew: {
        ...
        readonly permissions: readonly ["calls.place", "messages.read", "appointments.read", "appointments.update", "appointment_media.capture", "payments.read", "payments.collect", "expenses.submit"];
    };
    readonly read_only: {
        ...
        readonly permissions: readonly ["appointments.read", "audit.read", "automation.read", "contacts.read", "expenses.read", "properties.read", "pipeline.read", "messages.read", "policy.read", "quotes.read", "sales.read", "outbound.read", "partners.accounts.read", "partners.applications.read", "partners.joins.read", "partners.people.read", "partners.memberships.read", "partners.invitations.read", "partners.domains.read", "partners.security.read", "partners.quarantine.read", "partners.preview.read", "partners.commercial.read", "finance.read", "commissions.read", "marketing.read"];
    };
};
