...
module.exports = {
  ...
  testMatch: [
    ...
    "<rootDir>/src/__tests__/partner-cancellation-*.test.ts",
    "<rootDir>/src/__tests__/partner-embedded-*.test.ts",
    "<rootDir>/src/__tests__/partner-email-change.test.ts",
    "<rootDir>/src/__tests__/partner-hosted-checkout-provider.test.ts",
    "<rootDir>/src/__tests__/partner-identity-*.test.ts",
    "<rootDir>/src/__tests__/partner-location-*.test.ts",
    "<rootDir>/src/__tests__/partner-management-*.test.ts",
    "<rootDir>/src/__tests__/partner-mfa.test.ts",
    "<rootDir>/src/__tests__/partner-nullable-contact-auth.test.ts",
    ...
    "<rootDir>/src/__tests__/partner-recent-*.test.ts",
    ...
    "<rootDir>/src/__tests__/schedule-writer-inventory.test.ts",
