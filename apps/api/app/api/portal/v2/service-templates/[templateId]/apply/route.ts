...
import { applyPartnerServiceTemplate } from "@/lib/partner-repeat-work";
import {
...
export async function POST(
  ...
  try {
    ...
    const result = await applyPartnerServiceTemplate({
      actor,
      templateId: requirePortalUuid(rawTemplateId, "templateId"),
