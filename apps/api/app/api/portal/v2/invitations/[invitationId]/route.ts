...
export async function POST(
  ...
  try {
    ...
    if (!isPortalV2Uuid(invitationId))
      return createPartnerPortalV2ErrorResponse(
        "not_found",
        404,
        correlationId,
    ...
    if (
      !(await hasPartnerAccountInvitation(principal.accountId, invitationId))
    ) {
      return createPartnerPortalV2ErrorResponse(
        "not_found",
        404,
    ...
    console.error("[partner-portal-v2] invitation mutation failed", {
      correlationId,
