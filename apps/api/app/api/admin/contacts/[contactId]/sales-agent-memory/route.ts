...
import { getSalesAgentMemory } from "@/lib/sales-agent-memory";
...
export async function GET(
  ...
  // generate or refresh memory through the rebuild endpoint.
  const memory = await getSalesAgentMemory(db, contactIdTrimmed);
