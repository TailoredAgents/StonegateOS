    ...
    <section className="space-y-4">
      ...
      {appts.length === 0 ? (
        ...
        appts.map((a) => {
          ...
          const loadSizeSummary = formatAppointmentLoadSize(a.bookingDetails);
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 text-sm text-neutral-500">
                ...
                <span>{summarizeServiceLabels(a.services ?? [])}</span>
              </div>
              ...
              <p className="text-sm text-neutral-600">
                ...
                >
                  {a.property.addressLine1}, {a.property.city},{" "}
                  {a.property.state} {a.property.postalCode}
                </a>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                ...
                <details className="rounded-md border border-rose-200 bg-rose-50/50 px-2 py-1">
                  <summary className="cursor-pointer select-none text-xs font-semibold text-rose-700">
                    Cancel
                  </summary>
                  <form
                    action="/api/team/appointments/status"
                  ...
                  >
                    ...
                    <div className="space-y-2 rounded-md border border-neutral-200 bg-neutral-50 p-3">
                      ...
                      <p className="text-[11px] text-neutral-500">
                        Priced automatically at $0.14 per sq ft.
                      </p>
                    </div>
              ...
              >
                ...
                />
                <SubmitButton
                  className="rounded-md bg-neutral-800 px-3 py-1 text-xs font-semibold text-white hover:bg-neutral-700"
                  pendingLabel="Saving..."
                >
                  Save
                </SubmitButton>
