...
export function ContactsAddContactClient({
  teamMembers,
          ...
          <div className="mt-10 w-full max-w-2xl rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl">
            ...
            >
              ...
              <LeadSourceFields
                ...
                required
                label="Where from?"
                labelClassName="flex flex-col gap-1 text-sm text-slate-600"
                fieldClassName={TEAM_INPUT}
              />
              <label className="flex flex-col gap-1 text-sm text-slate-600">
              ...
              <div className="sm:col-span-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-600">
                Capture the original source here so contact reporting stays
              ...
              {showAddress ? (
                <>
                  ...
                  <div className="sm:col-span-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-800">
                    If you add an address, include street, city, state, and
                    postal code.
                  </div>
                </>
              ) : null}
