...
export const TEAM_INPUT =
  "rounded-xl border border-[color:var(--team-border)] bg-[color:var(--team-surface)] px-4 py-3 text-sm text-[color:var(--team-text)] shadow-sm placeholder:text-[color:var(--team-text-soft)] focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-100";

export const TEAM_INPUT_COMPACT =
  "rounded-xl border border-[color:var(--team-border)] bg-[color:var(--team-surface)] px-3 py-2 text-sm text-[color:var(--team-text)] shadow-sm placeholder:text-[color:var(--team-text-soft)] focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-100";
...
export function teamButtonClass(
  ...
  switch (variant) {
    ...
    default:
      return `inline-flex items-center justify-center rounded-full border border-[color:var(--team-border)] bg-[color:var(--team-surface)] ${sizeClass} font-semibold text-[color:var(--team-text)] shadow-sm transition hover:border-primary-300 hover:text-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-100 ${disabledClass}`;
  }
}
