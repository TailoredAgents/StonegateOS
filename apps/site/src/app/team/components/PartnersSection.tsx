        ...
        <div className={`${TEAM_CARD_PADDED} space-y-6`}>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-2xl border border-[color:var(--team-border)] bg-[color:var(--team-surface)] p-4">
              <h4 className="text-sm font-semibold text-[color:var(--team-text)]">Invite user</h4>
              ...
              <form action={partnerPortalInviteUserAction} className="mt-3 space-y-3">
                ...
                <label className="block">
                  <div className="text-[11px] font-semibold uppercase tracking-wide text-[color:var(--team-text-soft)]">Name</div>
                  <input name="name" className={TEAM_INPUT_COMPACT} placeholder="Jane Doe" />
                </label>
                <label className="block">
                  <div className="text-[11px] font-semibold uppercase tracking-wide text-[color:var(--team-text-soft)]">Email</div>
                  <input name="email" type="email" className={TEAM_INPUT_COMPACT} placeholder="jane@example.com" />
                </label>
                <label className="block">
                  <div className="text-[11px] font-semibold uppercase tracking-wide text-[color:var(--team-text-soft)]">Phone (optional)</div>
              ...
              <div className="mt-4 border-t border-[color:var(--team-border)] pt-4">
                <h5 className="text-xs font-semibold text-[color:var(--team-text-muted)]">Existing users</h5>
                {portalUsers.length === 0 ? (
                  <div className="mt-2 text-xs text-[color:var(--team-text-soft)]">No portal users yet.</div>
                ) : (
                  <ul className="mt-2 space-y-2 text-xs text-[color:var(--team-text-muted)]">
                    {portalUsers.map((user) => (
                      <li key={user.id} className="rounded-xl border border-[color:var(--team-border)] bg-[color:var(--team-surface-muted)] px-3 py-2">
                        <div className="flex items-center justify-between gap-2">
                          <div className="font-semibold text-[color:var(--team-text)]">{user.name}</div>
                          <span
                        ...
                        <div className="mt-1 text-[11px] text-[color:var(--team-text-soft)]">{user.email}</div>
                        {user.phoneE164 || user.phone ? (
                          <div className="mt-1 text-[11px] text-[color:var(--team-text-soft)]">{user.phoneE164 ?? user.phone}</div>
                        ) : null}
