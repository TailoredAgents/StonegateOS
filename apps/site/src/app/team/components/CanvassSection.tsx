                ...
                {items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <a href={`/team?tab=quotes&contactId=${encodeURIComponent(item.contact.id)}`} className="mt-3 block">
                    ...
                    {items.map((item) => {
                      ...
                      return (
                        <tr key={item.id} className={isActive ? "bg-primary-50/40" : "hover:bg-slate-50"}>
                          ...
                          <td className="px-4 py-3">
                            <a href={`/team?tab=quotes&contactId=${encodeURIComponent(item.contact.id)}`} className="block max-w-[320px]">
