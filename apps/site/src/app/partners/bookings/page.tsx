    ...
    <div className="space-y-5">
      <header className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/50">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Your upcoming scheduled service.
        </p>
        {created ? (
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="text-sm font-semibold text-slate-900">
                    {b.property
                      ? `${b.property.addressLine1}, ${b.property.city}, ${b.property.state} ${b.property.postalCode}`
                      : "Booking"}
                  </div>
                ...
                <div className="mt-1 text-xs text-slate-600">
                  {formatPortalDateTime(b.appointment.startAt)} -{" "}
                  {b.serviceKey ?? "service"}
                  {b.tierKey ? ` (${b.tierKey})` : ""}
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-3 text-xs">
                    <Link
                      ...
                      href={`/partners/book?${new URLSearchParams({
                        ...
                        rescheduleVersion: String(b.version),
                      }).toString()}`}
                    >
                      Reschedule
                    </Link>
