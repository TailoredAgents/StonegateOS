...
export const metadata = {
  title: "Instant junk removal estimate",
  description: "Get a rough junk removal estimate in under a minute, then pick a time and book online.",
    ...
    <Section>
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[420px_1fr] lg:items-start">
        <header className="space-y-4">
          ...
          <h1 className="font-display text-display text-primary-800">Get your instant junk removal estimate</h1>
          <p className="text-body text-neutral-600">
            Answer a few quick questions and get a rough range. Your crew confirms the set price in person before work starts.
          </p>
