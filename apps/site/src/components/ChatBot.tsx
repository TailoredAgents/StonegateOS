...
function fallbackResponse(message: string): string {
  ...
  if (m.includes("price") || m.includes("cost") || m.includes("quote") || m.includes("estimate"))
    return "We price by load size. Single item pickup is $100, minimum pickup (2â€“4 items) is $175, half load $350, 3/4 load $525, and a full load $700. Weâ€™ll confirm the exact price on-site.";
