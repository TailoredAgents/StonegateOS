...
- `[x]` Commission policy updated: sales commission retired, management set to 15% split 7.5% Jeffrey / 7.5% Austin, and labor fixed at 22.5% split evenly across selected crew members.
